...
WD=/scratch/$MyID/LizardRNAseq_Full_Script            ## Example:/scratch/$MyID/PracticeRNAseq  
DD=$WD/RawData
RDQ=RawDataQuality
...
RESULTSD=/home/$MyID/LizardRNAseq_Full/Counts_H_S_2024      ## Example:/home/aubtss/PracticeRNAseq/Counts_H_S
...
cp /scratch/${MyID}/reference/${REF}.fasta.gz .
...
hisat2-build --ss ${REF}.ss --exon ${REF}.exon ${REF}.fasta.gz LIZARD_index
