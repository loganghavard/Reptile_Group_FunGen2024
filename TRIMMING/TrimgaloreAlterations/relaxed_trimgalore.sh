...
WD=/scratch/$MyID/LizardTrimming/LizardRelaxedTrimGalore/LizardRNAseq_Full_Script            ## Example:/scratch/$MyID/PracticeRNAseq  
DD=$WD/RawData
RDQ=RawDataQuality
...
RESULTSD=/home/$MyID/trimming_group/trimgalore/relaxed_trimgalore
...
#while read i
#do
#	trim_galore --paired --q 20 --illumina --length 10 --stringency 13 "$i"_1.fastq "$i"_2.fastq -o ${CD}/
