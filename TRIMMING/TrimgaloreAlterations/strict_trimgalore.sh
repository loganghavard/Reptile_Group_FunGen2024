...
####THIS SCRIPT CHANGES TRIMGALORE PHRED SCORE CUTOFF TO 50####
####SET RAW DATA DIRECTORY THE SAME AS RELAXED TO CUT DOWN ON TIME AND DATA####
...
MyID=          ## Example: MyID=aubtss


WD=/scratch/$MyID/LizardTrimming/LizardStrictTrimGalore/LizardRNAseq_Full_Script            ## Example:/scratch/$MyID/PracticeRNAseq  
#Use same DD as relaxed
DD=/scratch/aubclsc0329/LizardTrimming/LizardRelaxedTrimGalore/LizardRNAseq_Full_Script/RawData
RDQ=RawDataQuality
...
REFD=$WD/LizardRefGenome          ## Example:/scratch/$MyID/PracticeRNAseq/DaphniaRefGenome    # this directory contains the indexed reference genome for the garter snake
...
RESULTSD=/home/$MyID/trimming_group/trimgalore/strict_trimgalore
REF=SceUnd1.0_top24                  ## This is what the "easy name" will be for the genome reference
...
#fasterq-dump --split-files SRR6825935 # Control sample 1
#fasterq-dump --split-files SRR6825934 # Control sample 2
#fasterq-dump --split-files SRR6825938 # Control sample 3
#fasterq-dump --split-files SRR6825926 # Control sample 4
#fasterq-dump --split-files SRR6825925 # Control sample 5
#fasterq-dump --split-files SRR6825930 # Control sample 6
#fasterq-dump --split-files SRR6825939 # Heat shock treatment sample 1
#fasterq-dump --split-files SRR6825941 # Heat shock treatment sample 2
#fasterq-dump --split-files SRR6825940 # Heat shock treatment sample 3
#fasterq-dump --split-files SRR6825933 # Heat shock treatment sample 4
#fasterq-dump --split-files SRR6825932 # Heat shock treatment sample 5
#fasterq-dump --split-files SRR6825928 # Heat shock treatment sample 6
...
#Strict trimgalore. This is highly inefficient as it processes each sample one-by-one

while read i
do
	trim_galore --paired --q 40 --length 40 --illumina "$i"_1.fastq "$i"_2.fastq -o ${CD}/
...
cp /scratch/${MyID}/reference/${REF}.fasta .
cp /scratch/${MyID}/reference/${REF}.gff3 .
...
hisat2-build --ss ${REF}.ss --exon ${REF}.exon ${REF}.fasta LIZARD_index
...
ls | grep ".fq" |cut -d "_" -f 1| sort | uniq > list    #should list Example: SRR629651
#Trimmomatic format: SRR6825933_2_val_2.fq
